...
class main{
    public static void main(String[] args) throws IOException {
        ...
        ResourceBundle labelsUS = ResourceBundle.getBundle("src/main/java/org/example/UtilLibrary/lang/label", localeEn);
        ResourceBundle labelsVN = ResourceBundle.getBundle("src/main/java/org/example/UtilLibrary/lang/label", localeVn);
